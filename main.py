    ...
    if event == 'Генерировать':
        if values[0] == '' or values[1] == '' or values[4] == '':
            ...
            if values[4] == 'dfs':
                ...
                print('Введено некорректное название алгоритма. Пожалуйста, выберите из предложенных')
                sg.popup('Введено некорректное название алгоритма. Пожалуйста, выберите из предложенных')
                continue
            drawing.pr_matze(a)
